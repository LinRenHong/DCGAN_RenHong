...
# my code
parser.add_argument('-load_path', default='model/each_eye_epoch/model_eye_10000_ep_300/model_eye_10000_epoch_280.pth', help='Checkpoint to load path from')
parser.add_argument('-num_output', default=64, help='Number of generated outputs')
args = parser.parse_args()


args.load_path = 'model/model_eye_10000_ep_300.pth'

# Load the checkpoint file.
state_dict = torch.load(args.load_path)

# if you use cpu
# state_dict = torch.load(args.load_path, map_location={'cuda:0': 'cpu'})
